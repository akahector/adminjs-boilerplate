...
styles:['/assets/custom.css'],
  ...
  locale:{
    ...
    translations:{
      ...
      //     Login:{
      //       messages:{
      //     welcomeMessage: 'Welcome to Tatsat Admin Panel',
      //     LoginWelcomeMessage:'Welcome to Tatsat Admin Panel',
      //     loginWelcomeMessage:'Welcome to Tatsat Admin Panel',
      //     loginwelcomeMessage:'Welcome to Tatsat Admin Panel',
      //     loginWelcome: 'Welcome to Tatsat Admin Panel',
      //     loginMessage: 'Welcome to Tatsat Admin Panel',
      //   }
      //     }
      //   }
        // messages:{
    ...
    resources: [{
      ...
      features:[
        uploadFileFeature({
          ...
          uploadPath: (record, filename) => (
            `${record.id()}/image/${filename}_${Date.now()}`
          ),
        }),
        uploadFileFeature({
          componentLoader,
          ...
          multiple:true,
          uploadPath: (record, filename) => (
            `${record.id()}/gallery/${filename}_${Date.now()}`
          ),
        })
      ]
    }, {
      ...
      features:[
        uploadFileFeature({
          ...
          uploadPath: (record, filename) => (
            `${record.id()}/icon/${filename}_${Date.now()}`
          ),
        }),
      ]
    },
